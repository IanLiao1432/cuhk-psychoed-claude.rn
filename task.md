...
| 53 | ExerciseLoadingScreen — calculation loading | **TODO** | Figma `0.3.0.7`. Loading/spinner screen shown at least 3 seconds while the result is being calculated by backend api after submitting all answers.                                                                                                                                                           |
